...
<div class="form-floating mb-3">
        <input type="text" name="AuthorId" class="form-control" id="floatingInput" placeholder="name@example.com">
        <label for="floatingInput">Author Id</label>
      </div>
...
<div class="form-floating mb-3">
        <input type="text" name="PublisherName" class="form-control" id="floatingInput" placeholder="name@example.com">
